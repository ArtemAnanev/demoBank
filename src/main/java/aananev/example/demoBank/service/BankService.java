package aananev.example.demoBank.service;

import aananev.example.demoBank.model.TransferBalance;
import aananev.example.demoBank.repo.BalanceRepository;
...
public class BankService {
    ...
    public void makeTransfer(TransferBalance transferBalance) {
        ...
        if (fromBalance == null || toBalance == null) throw new IllegalArgumentException("Empty Id");
        if (transferBalance.getAmount().compareTo(fromBalance) > 0)
            throw new IllegalArgumentException("You have no founds");
